...
export function IconMarqueeSection() {
  return (
    <section className="py-4 md:py-8 bg-background"> {/* Usando bg-background para alternar com a seção anterior (bg-gray-50) */}
      <div className="container mx-auto px-4">
        <h2 className="text-center font-headline text-2xl sm:text-3xl text-foreground mb-8">
          Para Quem Quer Vender Mais e Atender Melhor
        </h2>
