        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="bg-card p-6 sm:p-8 rounded-lg shadow-lg border text-center">
            ...
            <div className="text-center">
              ...
              <Button size="lg" className="mt-8 text-xl px-12 py-7 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg shadow-lg transform transition-transform hover:scale-105 font-bold animate-pulse-whatsapp" asChild>
